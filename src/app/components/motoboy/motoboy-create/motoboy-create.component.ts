...
@Component({
  selector: 'app-motoboy-create',
  templateUrl: './motoboy-create.component.html',
  styleUrls: ['./motoboy-create.component.css']
})
export class MotoboyCreateComponent implements OnInit {
  ...
  create(): void{
    this.service.create(this.motoboy).subscribe(()=>{
      this.toast.success('Motoboy cadastrado com sucesso', 'Cadastro');
