...
@Component({
  selector: 'app-motoboy-list',
  templateUrl: './motoboy-list.component.html',
  styleUrls: ['./motoboy-list.component.css']
})
export class MotoboyListComponent implements OnInit {
